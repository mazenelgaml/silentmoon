  ...
  Widget build(BuildContext context) {
   ...
   body: SingleChildScrollView(
     child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start,children: [
       Container(width:Get.width*0.999,height:Get.height*0.51,decoration: BoxDecoration(
       ...
       child: Column(
         ...
         children: [
           ...
           Padding(
             ...
             child: Center(child: Text("Get moving with Green Taxi",style: TextStyle(
               ...
               child: Center(
                 child: Column(children: [
                   ...
                   style: TextStyle( fontWeight: FontWeight.w500,
                       fontSize: 12,
                       color: Color(0xff303030)),)
                   ,Text("Terms of Service and Privacy Policy",style: TextStyle( fontWeight: FontWeight.bold,
                       fontSize: 12,
                       color: Color(0xff303030)),)
                 ],),
               ),
